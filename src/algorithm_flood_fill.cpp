...
void flood_fill(const graph_t& graph, visited_t& visited, int node,
                std::function<void(int node)> kernel) {
  visited[node] = true;
  kernel(node);
